...
const icon = (type = 'default') => {
  const svgs = {
    quad: `<svg viewBox="0 0 140 140" aria-hidden="true"><rect x="22" y="98" width="98" height="10" rx="5" class="motion-fill"/><circle cx="44" cy="48" r="10" class="motion-dot"/><path d="M38 59c15 4 25 17 32 38" class="motion-soft"/><path d="M30 103h63" class="motion-line"/><path d="M66 94l47-30" class="motion-line"/><path d="M105 62l18 5" class="motion-soft"/></svg>`,
    heel: `<svg viewBox="0 0 140 140" aria-hidden="true"><rect x="25" y="96" width="90" height="10" rx="5" class="motion-fill"/><circle cx="43" cy="47" r="10" class="motion-dot"/><path d="M38 59c18 4 28 18 35 36" class="motion-soft"/><path d="M31 101h43" class="motion-line"/><path d="M73 101c18-10 26-24 22-42" class="motion-line"/></svg>`,
    bridge: `<svg viewBox="0 0 140 140" aria-hidden="true"><rect x="18" y="103" width="104" height="9" rx="5" class="motion-fill"/><circle cx="38" cy="75" r="10" class="motion-dot"/><path d="M47 78c24-25 47-22 63 22" class="motion-line"/><path d="M26 108h34M102 108h22" class="motion-soft"/></svg>`,
    clam: `<svg viewBox="0 0 140 140" aria-hidden="true"><circle cx="38" cy="59" r="10" class="motion-dot"/><path d="M48 66c19 2 30 11 44 25" class="motion-soft"/><path d="M70 91l40-23" class="motion-line"/><path d="M69 93l43 13" class="motion-soft"/><path d="M54 105h73" class="motion-fill"/></svg>`,
    chair: `<svg viewBox="0 0 140 140" aria-hidden="true"><path d="M93 42h29v72" class="motion-soft"/><path d="M82 75h43" class="motion-soft"/><circle cx="54" cy="42" r="10" class="motion-dot"/><path d="M55 55l17 33" class="motion-line"/><path d="M72 88l-22 29" class="motion-line"/><path d="M72 88l25 25" class="motion-soft"/></svg>`,
    step: `<svg viewBox="0 0 140 140" aria-hidden="true"><path d="M70 112h50V85H88V58H58" class="motion-fill"/><circle cx="49" cy="36" r="10" class="motion-dot"/><path d="M52 49l19 43" class="motion-line"/><path d="M71 92l30-7" class="motion-line"/><path d="M71 92l-21 31" class="motion-soft"/></svg>`,
    calf: `<svg viewBox="0 0 140 140" aria-hidden="true"><path d="M104 32v86" class="motion-soft"/><circle cx="59" cy="38" r="10" class="motion-dot"/><path d="M61 51l7 43" class="motion-soft"/><path d="M68 94l-16 30" class="motion-line"/><path d="M69 94l26 29" class="motion-line"/><path d="M50 124h21M92 124h24" class="motion-soft"/></svg>`,
    balance: `<svg viewBox="0 0 140 140" aria-hidden="true"><path d="M104 33v86" class="motion-soft"/><circle cx="59" cy="39" r="10" class="motion-dot"/><path d="M61 52l7 39" class="motion-line"/><path d="M68 91l-14 31" class="motion-line"/><path d="M68 91l28 7" class="motion-soft"/><path d="M45 124h24" class="motion-fill"/></svg>`,
    back: `<svg viewBox="0 0 140 140" aria-hidden="true"><circle cx="48" cy="37" r="10" class="motion-dot"/><path d="M50 50c-4 18 1 34 17 48" class="motion-line"/><path d="M67 98l-23 28" class="motion-soft"/><path d="M67 98l38 25" class="motion-line"/><path d="M54 60l41 19" class="motion-soft"/></svg>`,
    cat: `<svg viewBox="0 0 140 140" aria-hidden="true"><circle cx="36" cy="68" r="10" class="motion-dot"/><path d="M48 72c22-20 45-20 66 0" class="motion-line"/><path d="M53 80l-13 34M97 80l14 34" class="motion-soft"/><path d="M28 116h24M100 116h24" class="motion-fill"/></svg>`,
    walk: `<svg viewBox="0 0 140 140" aria-hidden="true"><circle cx="59" cy="35" r="10" class="motion-dot"/><path d="M60 49l-6 35" class="motion-line"/><path d="M54 84l-23 36" class="motion-line"/><path d="M55 84l37 22" class="motion-soft"/><path d="M58 58l33-4" class="motion-soft"/></svg>`,
    water: `<svg viewBox="0 0 140 140" aria-hidden="true"><path d="M19 99c12-11 22 11 34 0s22 11 34 0 22 11 34 0" class="motion-line"/><path d="M19 117c12-11 22 11 34 0s22 11 34 0 22 11 34 0" class="motion-soft"/><circle cx="58" cy="36" r="10" class="motion-dot"/><path d="M60 48l12 38" class="motion-line"/><path d="M72 86l26-23" class="motion-soft"/></svg>`,
    ankle: `<svg viewBox="0 0 140 140" aria-hidden="true"><path d="M42 26c21 20 25 41 12 64" class="motion-soft"/><path d="M53 90l52 19" class="motion-line"/><path d="M83 112h34" class="motion-fill"/><path d="M52 89c12-3 23-2 33 5" class="motion-line"/></svg>`,
    default: `<svg viewBox="0 0 140 140" aria-hidden="true"><circle cx="52" cy="42" r="10" class="motion-dot"/><path d="M55 55l18 38" class="motion-line"/><path d="M72 92l-20 30" class="motion-line"/><path d="M73 92l31 24" class="motion-soft"/><path d="M58 64l38-12" class="motion-soft"/></svg>`
  };
  return svgs[type] || svgs.default;
};

const exercises = [
  {id:'easy-walk', name:'Easy walk', areas:['knee','hip','ankle','sciatica','pool'], icon:'walk', why:'Warms the body and builds stamina without heavy pounding.', how:'Walk on flat ground. Keep steps short and smooth. Stop before limping starts.', dose:'5–25 minutes', easier:'Walk indoors or break into 3–5 minute blocks.', harder:'Add 2–3 minutes per week.', warning:'Avoid hills if knee, hip, or sciatica pain flares.', source:sources.arthritisOA},
  {id:'water-walk', name:'Water walking', areas:['knee','hip','ankle','sciatica','pool'], icon:'water', why:'Water supports body weight, making movement easier on sore joints.', how:'Walk forward in chest-to-waist-deep water. Keep posture tall. Use slow arm swings.', dose:'8–25 minutes', easier:'Hold pool edge; shorter steps.', harder:'Add side steps or slightly faster pace.', warning:'Avoid twisting fast in the pool.', source:sources.arthritisOA},
  {id:'stationary-bike', name:'Stationary bike', areas:['knee','hip','ankle','pool'], icon:'walk', why:'Low-impact cardio that moves the knees and hips repeatedly without impact.', how:'Use low resistance. Seat high enough that the knee is not deeply bent at the top.', dose:'5–25 minutes', easier:'Rock pedals back and forth before full circles.', harder:'Add time before adding resistance.', warning:'Stop if knee pain rises or hip pinches.', source:sources.arthritisOA},
  ...
  {id:'ankle-pumps', name:'Ankle pumps', areas:['ankle','knee','pool'], icon:'ankle', why:'Gentle movement for ankle stiffness and circulation.', how:'Sit or lie down. Point toes away, then pull toes toward you.', dose:'2 sets × 15–20', easier:'Do one ankle at a time.', harder:'Add circles after pumps.', warning:'Stop if calf becomes painful, hot, or swollen.', source:sources.aaosKnee},
  ...
  {id:'sciatic-glide', name:'Sciatic nerve glide', areas:['sciatica'], icon:'back', why:'Gently moves the irritated nerve without aggressive stretching.', how:'Sit tall. Slowly straighten knee while bringing toes up, then lower. Keep it gentle.', dose:'1–2 sets × 8 each side', easier:'Smaller knee movement.', harder:'Only add reps, not force.', warning:'This should not create stronger tingling or numbness.', source:sources.nhsSciatica},
...
const workouts = [
  {
    ...
    steps:[
      ['Warm-up', 'Easy walk or bike', '5–10 min'],
  ...
  },
  {
    ...
    steps:[
      ['Warm-up', 'Walk, bike, or water walk', '5–10 min'],
  ...
  },
  {
    ...
    steps:[
      ['Warm-up', 'Short easy walk', '3–8 min'],
  ...
  {
    id:'workout-d', label:'Workout D', title:'Pool / Low-Impact Cardio Day', purpose:'Best for overweight patients, flare-up days, and building fitness without pounding.',
    steps:[
      ['Warm-up', 'Slow water walk or flat walk', '5 min'],
      ['Main cardio', 'Water walk, swim, bike, or elliptical', '8–25 min'],
      ['Ankle pumps', 'Circulation', '2×15'],
      ['Heel-toe rocks', 'Ankle control', '2×10'],
      ['Optional', 'Gentle side steps in water', '2 min'],
      ['Cool-down', 'Slow walk + breathing', '3–5 min']
    ]
  }
];
...
const prescriptions = {
  calm: {
    ...
    bullets:['5–10 minutes water walking, easy bike, or flat walk.', 'Heel slides, quad squeeze, pelvic tilt, and glute bridge only.', 'No step-ups, deep squats, long stairs, hills, or heavy carrying today.']
  },
  normal: {
    title:'Strength Day',
...
const areaLabels = {knee:'Knee', hip:'Hip', ankle:'Ankle/foot', sciatica:'Sciatica/back', pool:'Pool/cardio'};
...
function renderWorkouts() {
  ...
  grid.querySelectorAll('[data-save]').forEach(input => {
    input.addEventListener('change', () => localStorage.setItem(input.dataset.save, input.checked));
  });
}
...
function renderExercises(filter = 'all', query = '') {
  ...
  grid.innerHTML = filtered.map(ex => `
    <article class="exercise-card" data-areas="${ex.areas.join(' ')}">
      <div class="exercise-visual">${icon(ex.icon)}</div>
      <div class="exercise-content">
        <div class="tag-row">${ex.areas.map(area => `<span class="tag">${areaLabels[area]}</span>`).join('')}</div>
        <h3>${ex.name}</h3>
        <p>${ex.why}</p>
...
function init() {
  ...
  const openPrimer = () => { primer.hidden = false; primer.scrollIntoView({behavior:'smooth', block:'start'}); };
  ...
  document.getElementById('closePrimer')?.addEventListener('click', () => { primer.hidden = true; });
